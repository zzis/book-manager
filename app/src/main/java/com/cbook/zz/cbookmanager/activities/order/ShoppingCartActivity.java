...
import com.cbook.zz.cbookmanager.services.BorrowService;
...
//        service = new BorrowService(this.unitOfWork);
...
//        listView.setOnItemClickListener(new BookListActivity.ItemClickListener());
//
//    }
//    //获取点击事件
